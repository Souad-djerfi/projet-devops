Vagrant.configure(2) do |config|
  ...
  SHELL
	...
	NODES = [
  	{ :hostname => "node1", :ip => "192.168.56.10", :cpus => 1, :mem => 1024 },
  	{ :hostname => "node2", :ip => "192.168.56.11", :cpus => 1, :mem => 1024 },
    { :hostname => "node3", :ip => "192.168.56.12", :cpus => 1, :mem => 1024 },
    { :hostname => "node4", :ip => "192.168.56.13", :cpus => 1, :mem => 1024 }
	]
